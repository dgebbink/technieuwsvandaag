...
def generate_image_prompt(title: str, article_text: str) -> str:
    ...
    prompt = (
        ...
        "toegankelijke settings. Als het artikel gaat over of prominente "
        "vermelding maakt van een Big Tech bedrijf of product — waaronder "
        "maar niet beperkt tot Apple, Google, Microsoft, Meta, Samsung, "
        "Amazon, Tesla, Nvidia, OpenAI, Anthropic, of een ander wereldwijd "
        "erkend tech-merk — MOET je de visuele identiteit van dat merk het "
        "middelpunt van de afbeelding maken: verwerk het bedrijfslogo "
        "duidelijk, gebruik het kenmerkende kleurenpalet van het merk, of "
        "toon het daadwerkelijke product. Dit is verplicht. Geen nep- of "
        "niet-herkenbare merken. Stijl: professionele persfotografie met "
        "een positieve, energieke uitstraling. Max 2 zinnen.\n\n"
