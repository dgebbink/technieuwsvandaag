...
def generate_image_prompt(title: str, article_text: str) -> str:
    ...
    prompt = (
        ...
        "toegankelijke settings. Als het artikel over een specifiek bekend "
        "technologiebedrijf gaat (zoals Apple, Google, Microsoft, Samsung, "
        "etc.), mag je optioneel het logo of de herkenbare merkidentiteit "
        "subtiel in de afbeelding verwerken — maar alleen als dit de "
        "compositie versterkt. Geen tekst in de afbeelding. Geen onbekende "
        "of nep-merken. Stijl: professionele persfotografie met een "
