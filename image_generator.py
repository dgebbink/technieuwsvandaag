...
def generate_image_prompt(title: str, article_text: str) -> tuple[str, str | None]:
    ...
    instruction = (
        ...
        "offices, crisp interfaces, futuristic but accessible settings. Do NOT "
        "describe any logos, text, letters or brand names in the image — the real "
        "logo will be composited on top afterwards. Convey brand identity through "
        "color palette, product design or associated scene instead.\n"
