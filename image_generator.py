...
def generate_image_prompt(title: str, article_text: str) -> str:
    ...
    instruction = (
        ...
        "If people appear in the scene, show predominantly women in active, "
        "central, professional roles; make women clearly the central figures and "
        "add men only rarely. If applicable, show young adults (approximately 18 "
        "to 30 years old). Also apply diversity from an ethnic perspective.\n\n"
